    ...
    function setupBinancePay() {
        ...
        Livewire.on('deposit-binance', function(event) {
            ...
            .catch(function(error) {
                ...
                var msg = error.message || 'Payment failed. Please try again.';
                
                if (msg.includes('IP') || msg.includes('whitelist')) {
                    msg += '\n\n💡 Tip: Server IP needs to be whitelisted in Binance Pay dashboard.';
                } else if (msg.includes('not configured')) {
                    msg += '\n\n💡 Tip: Contact administrator to configure Binance Pay.';
                } else if (msg.includes('authentication') || msg.includes('API')) {
                    msg += '\n\n💡 Tip: Please check API credentials.';
                }
