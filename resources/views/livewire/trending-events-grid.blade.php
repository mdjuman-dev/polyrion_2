<div wire:poll.5s="refreshEvents" data-component="trending-events-grid">
    <!-- Markets Grid -->
                ...
                <div class="market-card multi-market">
                    ...
                    <div class="market-footer">
                        ...
                        <div class="market-actions d-flex gap-2">
                            <livewire:save-event :event="$event" :key="'trending-' . $event->id" />
                        </div>
                    </div>
                </div>
            @else
                ...
                <div class="market-card single-market">
                    ...
                    <div class="market-footer">
                        ...
                        <div class="market-actions d-flex gap-2">
                            <livewire:save-event :event="$event" :key="'trending-single-' . $event->id" />
                        </div>
                    </div>
                </div>
            @endif
