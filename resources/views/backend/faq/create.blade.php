                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h4 class="box-title">
                                    <i class="fa fa-plus-circle"></i> Create New FAQ
                                </h4>
                            </div>
                            <div class="box-body">
                                <form action="{{ route('admin.faqs.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="question" class="form-control @error('question') is-invalid @enderror" 
                                            value="{{ old('question') }}" placeholder="Enter question" required maxlength="500">
                                        @error('question')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="answer" class="form-control textarea @error('answer') is-invalid @enderror" 
                                            rows="10" placeholder="Enter answer" required>{{ old('answer') }}</textarea>
                                        @error('answer')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
