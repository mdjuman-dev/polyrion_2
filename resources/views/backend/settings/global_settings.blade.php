                              ...
                              <div class="col-md-3 settings-sidebar">
                                 <div class="settings-nav">
                                    <ul class="nav nav-pills flex-column" role="tablist">
                                       ...
                                       <li class="nav-item">
                                          <a class="nav-link" data-bs-toggle="pill" href="#logo" role="tab">
                                             <div class="nav-icon">
                                       ...
                                       <li class="nav-item">
                                          <a class="nav-link" data-bs-toggle="pill" href="#analytics" role="tab">
                                             <div class="nav-icon">
                                       ...
                                       <li class="nav-item">
                                          <a class="nav-link" data-bs-toggle="pill" href="#facebook" role="tab">
                                             <div class="nav-icon">
                                       ...
                                       <li class="nav-item">
                                          <a class="nav-link" data-bs-toggle="pill" href="#google-oauth" role="tab">
                                             <div class="nav-icon">
                                       ...
                                       <li class="nav-item">
                                          <a class="nav-link" data-bs-toggle="pill" href="#smtp" role="tab">
                                             <div class="nav-icon">
                                       ...
                                       <li class="nav-item">
                                          <a class="nav-link" data-bs-toggle="pill" href="#email-templates" role="tab">
                                             <div class="nav-icon">
                              ...
                              <div class="col-md-9 settings-content">
                                 <div class="tab-content p-4">
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group mb-3">
                                                ...
                                                <select name="app_theme" class="form-control">
                                                   <option value="all" {{ old('app_theme', $generalSettings['app_theme'] ?? '') == 'all' ? 'selected' : '' }}>
                                                      All Theme</option>
                                                   <option value="light" {{ old('app_theme', $generalSettings['app_theme'] ?? '') == 'light' ? 'selected' : '' }}>
                                                      Light Theme</option>
                                                   <option value="dark" {{ old('app_theme', $generalSettings['app_theme'] ?? '') == 'dark' ? 'selected' : '' }}>
                                                      Dark Theme</option>
                                                </select>
                                             </div>
                                          </div>
                                          <div class="col-md-12">
                                             <div class="form-group mb-3">
                                                ...
                                                <select name="commission_type" class="form-control">
                                                   <option value="commission" {{ old('commission_type', $generalSettings['commission_type'] ?? '') == 'commission' ? 'selected' : '' }}>
                                                      Commission</option>
                                                   <option value="fixed" {{ old('commission_type', $generalSettings['commission_type'] ?? '') == 'fixed' ? 'selected' : '' }}>
                                                      Fixed Fee</option>
                                                   <option value="hybrid" {{ old('commission_type', $generalSettings['commission_type'] ?? '') == 'hybrid' ? 'selected' : '' }}>
                                                      Hybrid</option>
                                                </select>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group mb-3">
                                                ...
                                                <select name="app_timezone" class="form-control">
                                                   <option value="Asia/Dhaka" {{ old('app_timezone', $generalSettings['app_timezone'] ?? '') == 'Asia/Dhaka' ? 'selected' : '' }}>
                                                      Asia/Dhaka</option>
                                                   <option value="UTC" {{ old('app_timezone', $generalSettings['app_timezone'] ?? '') == 'UTC' ? 'selected' : '' }}>
                                                      UTC</option>
                                                   <option value="America/New_York" {{ old('app_timezone', $generalSettings['app_timezone'] ?? '') == 'America/New_York' ? 'selected' : '' }}>
                                             ...
                                             <div class="form-group mb-4">
                                                ...
                                                @if (isset($generalSettings['logo']) && $generalSettings['logo'])
                                                   <div class="current-image-container mb-3">
                                                      <label class="text-muted small mb-2 d-block">Current
                                                         Logo:</label>
                                                      <div class="image-preview-wrapper">
                                                         <img
                                                            src="{{ str_starts_with($generalSettings['logo'], 'http') ? $generalSettings['logo'] : asset('storage/' . $generalSettings['logo']) }}"
                                                            alt="Current Logo" id="current_logo_img" class="current-image"
                                                ...
                                                @if (isset($generalSettings['favicon']) && $generalSettings['favicon'])
                                                   <div class="current-image-container mb-3">
                                                      ...
                                                      <div class="favicon-preview-wrapper">
                                                         <img
                                                            src="{{ str_starts_with($generalSettings['favicon'], 'http') ? $generalSettings['favicon'] : asset('storage/' . $generalSettings['favicon']) }}"
                                    ...
                                    <div class="tab-pane fade" id="google-oauth" role="tabpanel">
                                       ...
                                       <div class="alert alert-info mb-4">
                                          ...
                                          Get your OAuth credentials from <a
                                             ...
                                             class="alert-link">Google Cloud Console</a>
                                       </div>
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group mb-3">
                                                ...
                                                <select name="mail_mailer" class="form-control" required>
                                                   <option value="smtp" {{ old('mail_mailer', $mailSettings['mail_mailer'] ?? 'smtp') == 'smtp' ? 'selected' : '' }}>
                                                      SMTP</option>
                                                   <option value="sendmail" {{ old('mail_mailer', $mailSettings['mail_mailer'] ?? '') == 'sendmail' ? 'selected' : '' }}>
                                                      Sendmail</option>
                                                   <option value="log" {{ old('mail_mailer', $mailSettings['mail_mailer'] ?? '') == 'log' ? 'selected' : '' }}>
                                                      Log (Testing)</option>
                                                </select>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group mb-3">
                                                ...
                                                <select name="mail_encryption" class="form-control">
                                                   <option value="tls" {{ old('mail_encryption', $mailSettings['mail_encryption'] ?? 'tls') == 'tls' ? 'selected' : '' }}>
                                                      TLS</option>
                                                   <option value="ssl" {{ old('mail_encryption', $mailSettings['mail_encryption'] ?? '') == 'ssl' ? 'selected' : '' }}>
                                                      SSL</option>
                                                   <option value="" {{ old('mail_encryption', $mailSettings['mail_encryption'] ?? '') == '' ? 'selected' : '' }}>
                                                      None</option>
                                                </select>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-6">
                                             <div class="form-group mb-3">
                                                ...
                                                <input type="password" name="mail_password" class="form-control"
                                                   ...
                                                   placeholder="Gmail App Password (16 characters)" required>
                                                <small class="form-text text-muted">
                                    ...
                                    <div class="tab-pane fade" id="email-templates" role="tabpanel">
                                       ...
                                       <div class="card mb-4">
                                          ...
                                          <div class="card-body">
                                             <div class="btn-group template-selector" role="group">
                                                <button type="button" class="btn btn-primary active template-btn"
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   <label class="form-label">Email Subject <span
                                                         class="text-danger">*</span></label>
                                                   <input type="text" name="reset_password_subject" class="form-control"
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   <label class="form-label">Greeting <span
                                                         class="text-danger">*</span></label>
                                                   <input type="text" name="reset_password_greeting" class="form-control"
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   ...
                                                   <textarea name="reset_password_line1" class="form-control" rows="3"
                                                      required
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   <label class="form-label">Button Text <span
                                                         class="text-danger">*</span></label>
                                                   <input type="text" name="reset_password_action_text"
                                                      class="form-control"
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   <label class="form-label">Second Line (Expiry Message)
                                                      <span class="text-danger">*</span></label>
                                                   <textarea name="reset_password_line2" class="form-control" rows="2"
                                                      required
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   <label class="form-label">Third Line (Security Message)
                                                      <span class="text-danger">*</span></label>
                                                   <textarea name="reset_password_line3" class="form-control" rows="2"
                                                      required
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   <label class="form-label">Salutation (Closing) <span
                                                         class="text-danger">*</span></label>
                                                   <input type="text" name="reset_password_salutation" class="form-control"
                                       ...
                                       <div id="welcome-template" class="template-section" style="display: none;">
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   ...
                                                   <input type="text" name="welcome_email_subject" class="form-control"
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   ...
                                                   <input type="text" name="welcome_email_greeting" class="form-control"
                                       ...
                                       <div id="verification-template" class="template-section" style="display: none;">
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   <label class="form-label">Email Subject</label>
                                                   <input type="text" name="verification_email_subject"
                                                      class="form-control"
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   <label class="form-label">Greeting</label>
                                                   <input type="text" name="verification_email_greeting"
                                                      class="form-control"
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   ...
                                                   <textarea name="verification_email_message" class="form-control"
                                                      rows="4"
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                   ...
                                                   <input type="text" name="verification_email_button_text"
                                                      class="form-control"
