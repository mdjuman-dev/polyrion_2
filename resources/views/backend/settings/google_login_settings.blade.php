                              ...
                              <div class="col-md-3 settings-sidebar">
                                 <div class="settings-nav">
                                    <ul class="nav nav-pills flex-column" role="tablist">
                                       <li class="nav-item">
                                          <a class="nav-link active" data-bs-toggle="pill" href="#google-oauth" role="tab">
                                             <div class="nav-icon">
                                    ...
                                    <div class="tab-pane fade show active" id="google-oauth" role="tabpanel">
                                       <div class="d-flex justify-content-between align-items-center mb-4">
                                          <div>
                                             ...
                                             <p class="text-muted mb-0">Configure Google OAuth credentials for user login.
                                                These credentials will be stored in the database settings.</p>
                                          </div>
                                       </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <div class="form-group mb-3">
                                                ...
                                                <small class="form-text text-muted mt-2">Your Google OAuth Client ID (e.g.,
                                                   498087143603-xxxxx.apps.googleusercontent.com)</small>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group mb-3">
                                                ...
                                                <small class="form-text text-muted mt-2">Your Google OAuth Client
                                                   Secret</small>
                                             </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group mb-3">
                                                ...
                                                <small class="form-text text-muted mt-2">The callback URL where Google will
                                                   redirect after authentication. Must match the URL configured in Google
                                                   Cloud Console.</small>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="alert alert-warning mt-4">
                                          ...
                                          <ul class="mb-0 mt-2">
                                             <li>Make sure the Redirect URL matches exactly with the one configured in
                                             ...
                                             <li>After updating these settings, clear the cache for changes to take effect
                                             </li>
                                          </ul>
                                       </div>
                                    </div>
