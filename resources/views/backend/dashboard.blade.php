                    ...
                    <div class="col-12 col-xl-12">
                        <div class="customhtab_1 box-header px-0 pt-0 border-bottom-0 ">
                            <ul class="nav nav-pills ">
                                <li class=" nav-item "> <a href="index.html#" class="nav-link fw-500" data-bs-toggle="tab"
                                        aria-expanded="false">Crypto </a> </li>
                                <li class="mt-5 text-fade"> <a>/</a> </li>
                                <li class="nav-item "> <a href="index.html#" class="nav-link fw-500" data-bs-toggle="tab"
                                        aria-expanded="false">Coins</a> </li>
                                <li class="mt-5 text-fade"> <a>/</a> </li>
                                <li class="nav-item "> <a href="index.html#" class="nav-link active fw-500"
                                        data-bs-toggle="tab" aria-expanded="true ">Etherium</a></li>
                            </ul>
                            <ul class="box-controls_2 box-tools pull-right">
                                <li>
                                    <div class="dropdown">
                                        <button
                                            class="btn btn-rounded btn-outline btn-light dropdown-toggle fw-600 mb-5 fs-14 p-1 px-3 me-1 border-0"
                                            type="button" data-bs-toggle="dropdown" aria-expanded="false">Earn</button>
                                        <div class="dropdown-menu" style="">
                                            <a class="dropdown-item" href="index.html#"><i class="fa fa-plus"></i> New</a>
                                            <a class="dropdown-item" href="index.html#"><i class="fa fa-pencil"></i>
                                                Edit</a>
                                            <a class="dropdown-item" href="index.html#"><i class="fa fa-trash-o"></i>
                                                Delete</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="index.html#"><i class="fa fa-share-alt"></i>
                                                Share</a>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="dropdown">
                                        <button
                                            class="btn btn-rounded btn-outline btn-light dropdown-toggle fw-600 mb-5 fs-14 p-1 px-3 me-1 border-0"
                                            type="button" data-bs-toggle="dropdown" aria-expanded="false">Gaming</button>
                                        <div class="dropdown-menu" style="">
                                            <a class="dropdown-item" href="index.html#"><i class="fa fa-plus"></i> New</a>
                                            <a class="dropdown-item" href="index.html#"><i class="fa fa-pencil"></i>
                                                Edit</a>
                                ...
                                <li>
                                    <div class="dropdown">
                                        <button
                                            class="btn btn-rounded btn-outline btn-light dropdown-toggle fw-600 mb-5 fs-14 p-1 px-3 me-1 border-0"
                                            type="button" data-bs-toggle="dropdown" aria-expanded="false">Exchange</button>
                                        <div class="dropdown-menu" style="">
                                            <a class="dropdown-item" href="index.html#"><i class="fa fa-plus"></i> New</a>
                                            <a class="dropdown-item" href="index.html#"><i class="fa fa-pencil"></i>
                                                Edit</a>
                                ...
                                <li>
                                    <div class="dropdown">
                                        <button
                                            class="btn btn-rounded btn-outline btn-light dropdown-toggle fw-600 mb-5 fs-14 p-1 px-3 me-1 border-0"
                                            type="button" data-bs-toggle="dropdown" aria-expanded="false">Buy</button>
                                        <div class="dropdown-menu" style="">
                                            <a class="dropdown-item" href="index.html#"><i class="fa fa-plus"></i> New</a>
                                            <a class="dropdown-item" href="index.html#"><i class="fa fa-pencil"></i>
                                                Edit</a>
                        ...
                        <div class=" box-body">
                                ...
                                <div class=" d-flex m-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="main_font_1 mb-0 fw-500">$3,400.80
                                            <sup><small class=" text-success"><i
                                                        class="fa fa-caret-up text-success me-1"></i>0.50%</small></sup>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="flexbox align-items-center mt-10">
                                <div>
                                    ...
                                    <div class="clearfix">
                                        <a type="button" href="tags.html"
                                            class="waves-effect waves-light fw-600 btn btn-rounded btn-light mb-5 fs-14 p-1 px-3 me-1 mt-3">Mineable</a>
                                        <a type="button" href="tags.html"
                                            class="waves-effect waves-light fw-600 btn btn-rounded btn-light mb-5 fs-14 p-1 px-3 me-1 mt-3">PoW</button>
                                            <a type="button" href="tags.html"
                                                class="waves-effect waves-light fw-600 btn btn-rounded btn-light mb-5 fs-14 p-1 px-3 me-1 mt-3">Smart
                                                Contracts</a>
                                            <a type="button" href="tags.html"
                                                class="waves-effect waves-light fw-600 btn btn-rounded btn-light mb-5 fs-14 p-1 px-3 me-1 mt-3">Etherium</a>
                                            <a type="button" href="tags.html"
                                                class="btn btn-rounded fw-600 text-primary mb-5 fs-14 p-1 px-3 me-1 mt-3">View
                                                all</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="box-body">
                                            <div class="flexbox align-items-center">
                                                ...
                                                <div class="card-controls text-end">
                                                    <li class="dropdown">
                                                        <a data-bs-toggle="dropdown" href="index.html#"><i
                                                                class="fa fa-info-circle fs-20 text-fade"></i></a>
                                            ...
                                            <div class=" mt-20">
                                                ...
                                                <p class="mb-5"><small class="fs-14 text-success "><i
                                                            class="fa fa-caret-up text-success me-1"></i>5.50%</small></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="box pull-up">
                                        <div class="box-body">
                                            ...
                                            <div class=" mt-20">
                                                ...
                                                <p class="mb-5"><small class="fs-14 text-danger "><i
                                                            class="fa fa-caret-down text-danger me-1"></i>1.25%</small></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="box pull-up">
                                        <div class="box-body">
                                            ...
                                            <div class=" mt-20">
                                                ...
                                                <p class="mb-5"><small class="fs-14 text-success "><i
                                                            class="fa fa-caret-up text-success me-1"></i>0.50%</small></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-3 col-md-6 d-lg-block">
                                    <div class="box pull-up">
                                        <div class="box-body">
                                            ...
                                            <div class=" mt-20">
                                                <h2 class="fw-500 mb-0">852,147<span class="fs-30 fw-300 text-fade">
                                                        ETH</span></h2>
                    ...
                    <div class="col-12 col-xl-9">
                        ...
                        <div class="box box-body p-20">
                            ...
                            <div class="customhtab box-header px-0 border-bottom-0">
                                <ul class="nav nav-pills">
                                    <li class=" nav-item"> <a href="index.html#navpills-1" class="nav-link active"
                                            data-bs-toggle="tab" aria-expanded="false">Overview</a> </li>
                                    <li class="nav-item"> <a href="index.html#navpills-3" class="nav-link "
                                            data-bs-toggle="tab" aria-expanded="false">Market</a> </li>
                                    <li class="nav-item"> <a href="index.html#navpills-2" class="nav-link"
                                            data-bs-toggle="tab" aria-expanded="true">Wallets</a></li>
                                    <li class="nav-item"> <a href="index.html#navpills-4" class="nav-link"
                                            data-bs-toggle="tab" aria-expanded="true">Ratings</a> </li>
                                    <li class="nav-item"> <a href="index.html#navpills-5" class="nav-link"
                                            data-bs-toggle="tab" aria-expanded="true">Analysis</a> </li>
                                </ul>
                                    ...
                                    <div class="box">
                                        <div class="box-header with-border p-0">
                                            <ul class="nav nav-pills mb-20">
                                                <li class=" nav-item"> <a href="index.html#Overview-1"
                                                        class="nav-link active" data-bs-toggle="tab"
                                                        aria-expanded="false">Price</a> </li>
                                                <li class="nav-item"> <a href="index.html#Overview-2" class="nav-link"
                                                        data-bs-toggle="tab" aria-expanded="false">Market cap</a> </li>
                                                <li class="nav-item"> <a href="index.html#Overview-3" class="nav-link"
                                                        data-bs-toggle="tab" aria-expanded="true">Trading</a></li>
                                                <li class="nav-item"> <a href="index.html#Overview-4" class="nav-link"
                                                        data-bs-toggle="tab" aria-expanded="true">USD</a> </li>
                                                <li class="nav-item"> <a href="index.html#Overview-5" class="nav-link"
                                                        data-bs-toggle="tab" aria-expanded="true">BTC</a> </li>
                                            </ul>
                                            <div class="box-tools_1 pull-right">
                                                <div class="btn-group" id="realtime" data-toggle="btn-toggle">
                                                    <button type="button" class="btn btn-default bg-light btn-sm"
                                                ...
                                                <table class="table table-bordered no-margin">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>1.2126281 BTC</td>
                                                            <td>
                                                                <time class="timeago" datetime="2018-02-01T13:38:01Z"
                                                                    title="2018-02-01 13:38 GMT">2 minutes ago</time>
                                                            </td>
                                                            <td>medium</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <time class="timeago" datetime="2018-02-01T13:38:00Z"
                                                                    title="2018-02-01 13:38 GMT">2 minutes ago</time>
                                                            </td>
                                                            <td>high</td>
                                                        ...
                                                        <table class="table table-hover no-margin text-center">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>BTC - 12458</td>
                                                                    <td>0.002548548</td>
                                                                    <td>+12.85% <i class="fa fa-arrow-up text-success"></i>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>BTC - 02157</td>
                                                                    <td>0.025486854</td>
                                                                    <td>+05.15% <i class="fa fa-arrow-up text-success"></i>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>BTC - 12458</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>0.025845218</td>
                                                                    <td>-02.01% <i
                                                                            class="fa fa-arrow-down text-danger"></i></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>BTC - 35487</td>
                                                                    <td>0.021548754</td>
                                                                    <td>+06.15% <i class="fa fa-arrow-up text-success"></i>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>BTC - 03254</td>
                                                ...
                                                <div class="box-body text-center">
                                                    ...
                                                    <ul class="flexbox flex-justified text-center mt-20">
                                                        ...
                                                        <li>
                                                            <div>% 7d</div>
                                                            <small class="fs-18"><i
                                                                    class="fa fa-arrow-up text-success pe-5"></i>54.77</small>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-12">
                                            <div class="box box-inverse bg-primary bg-hexagons-dark pull-up">
                                                <div class="box-body text-center">
                                                    ...
                                                    <ul
                                                        class="flexbox flex-justified text-center mt-30 bb-1 border-light pb-20">
                                                    ...
                                                    <ul class="flexbox flex-justified text-center mt-20">
                                                        <li class="be-1 border-light">
                                                            <div>% 1h</div>
                                                            <small class="fs-18"><span><i
                                                                        class="fa fa-arrow-up text-success pe-5"></i>0.4</span></small>
                                                        </li>

                                                        <li class="be-1 border-light">
                                                            <div>% 24h</div>
                                                            <small class="fs-18"><span><i
                                                                        class="fa fa-arrow-up text-success pe-5"></i>9.29</span></small>
                                                        </li>

                                                        <li>
                                                            <div>% 7d</div>
                                                            <small class="fs-18"><span><i
                                                                        class="fa fa-arrow-up text-success pe-5"></i>50.77</span></small>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div class="box-body">
                                <div class="flexbox align-items-center">
                                    ...
                                    <div class="card-controls text-end">
                                        <li class="dropdown">
                                            <a data-bs-toggle="dropdown" href="index.html#"><i
                                                    class="fa fa-caret-down text-light me-1 fs-20"></i></a>
                                            <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <a href="index.html#" class="market-pair">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="mb-0 text-success fw-600"><i
                                                            class="fa fa-caret-up text-success me-1"></i> 0.80%</p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <a href="index.html#" class="market-pair  pb-2">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="mb-0 text-danger fw-600"><i
                                                            class="fa fa-caret-down text-danger me-1"></i> 0.40%</p>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
