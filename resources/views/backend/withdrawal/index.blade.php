                                    ...
                                    <tbody>
                                        @forelse($withdrawals as $withdrawal)
                                            <tr>
                                                ...
                                                <td>
                                                    <strong>{{ number_format($withdrawal->amount, 2) }} {{ $withdrawal->currency }}</strong>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        @if($withdrawal->status == 'pending')
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-warning processing-btn" 
                                                                data-id="{{ $withdrawal->id }}" title="Mark as Processing">
