      ...
      : json_decode($withdrawal->payment_details, true);
                     ...
                     <div class="col-lg-4">
                           ...
                           <div class="box">
                              ...
                              <div class="box-body">
                                 ...
                                 <a href="{{ route('admin.withdrawal.approve', $withdrawal->id) }}"
                                    class="btn btn-success btn-block mb-2 approve-btn">
                                    <i class="fa fa-check"></i> Approve
                                 </a>

                                 <a href="{{ route('admin.withdrawal.reject', $withdrawal->id) }}"
                                    class="btn btn-danger btn-block mb-2 reject-btn">
                                 ...
                                 @if($withdrawal->status == 'pending')
                                    <a href="{{ route('admin.withdrawal.processing', $withdrawal->id) }}"
                                       class="btn btn-warning btn-block processing-btn">
                        ...
                        @else
                           ...
                           <div class="box">
                              <div class="box-header">
                                 <h5 class="box-title">Request Settled</h5>
                              </div>
                              <div class="box-body text-center">
                                 @if($withdrawal->status == 'completed')
                                    <span class="badge bg-success p-2"><i class="fa fa-check-circle"></i> Already Approved</span>
                                 @else
                                    <span class="badge bg-danger p-2"><i class="fa fa-times-circle"></i> Already Rejected</span>
                                 @endif
                              </div>
                           </div>
                        @endif
