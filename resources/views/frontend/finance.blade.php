                            ...
                            <div style="padding: 12px 16px 20px 16px;">
                                ...
                                <div class="filter-list" style="display: flex; flex-direction: column; gap: 2px;">
                                    @foreach($secondaryCategories as $secCategory)
                                        <a href="{{ route('finance.index') }}?secondary_category={{ $secCategory->id }}{{ $selectedTimeframe !== 'all' ? '&timeframe=' . $selectedTimeframe : '' }}{{ $selectedCategory !== 'all' ? '&category=' . $selectedCategory : '' }}" 
