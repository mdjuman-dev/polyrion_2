...
@section('meta_derails')
    <title>Withdraw Funds - Polymarket</title>
@endsection
@section('content')
            ...
            <div class="col-lg-7 col-md-12 mb-4">
                <div class="profile-card">
                    ...
                    <div class="withdrawal-balance-card">
                        ...
                        <div class="balance-value">{{ number_format($wallet->balance, 2) }} {{ $wallet->currency }}</div>
                        ...
                        <div id="paymentDetailsContainer">
                            ...
                            <div id="bankDetails" class="payment-details-section" style="display: none;">
                                ...
                                <div class="form-group-custom">
                                    ...
                                    <input type="text" class="form-input-custom" id="account_number" name="account_number" 
                                        placeholder="Enter account number">
                                </div>
                                <div class="form-group-custom">
                                    <label for="account_holder" class="form-label-custom">Account Holder Name</label>
                                    <input type="text" class="form-input-custom" id="account_holder" name="account_holder" 
                            ...
                            <div id="cryptoDetails" class="payment-details-section" style="display: none;">
                                ...
                                <div class="form-group-custom">
                                    ...
                                    <input type="text" class="form-input-custom" id="wallet_address" name="wallet_address" 
                            ...
                            <div id="paypalDetails" class="payment-details-section" style="display: none;">
                                ...
                                <div class="form-group-custom">
                                    ...
                                    <input type="email" class="form-input-custom" id="paypal_email" name="paypal_email" 
                                    ...
                                    <div class="withdrawal-history-item">
                                        ...
                                        <div class="withdrawal-item-details">
                                            <div class="withdrawal-item-method">
                                                <i class="fas fa-{{ $withdrawal->payment_method == 'bank' ? 'university' : ($withdrawal->payment_method == 'crypto' ? 'coins' : 'paypal') }}"></i>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    submitBtn.prop('disabled', false).html('<i class="fas fa-paper-plane"></i> Submit Withdrawal Request');
                }
            },
            error: function(xhr) {
