         ...
         <div class="secondary-filters">
            <div class="filter-top-bar d-lg-flex d-block">
               ...
               <div class="filters-section-wrapper ms-lg-4">
                  ...
                  <button class="filter-scroll-btn filter-scroll-right" id="filterScrollRight" aria-label="Scroll right">
                  ...
                  <div class="filter-dropdown-wrapper sort-by-wrapper">
                     ...
                     <div class="sort-dropdown-menu">
                        <ul>
                           ...
                           <li class="sort-option" data-sort="liquidity" onclick="setSortBy('liquidity', 'Liquidity')">
                     ...
                     <div class="frequency-dropdown-menu">
                        <ul>
                           <li class="frequency-option" data-frequency="all" onclick="setFrequency('all', 'All')">
                              All</li>
                           <li class="frequency-option" data-frequency="daily" onclick="setFrequency('daily', 'Daily')">
                              Daily</li>
                           <li class="frequency-option" data-frequency="weekly" onclick="setFrequency('weekly', 'Weekly')">
                              Weekly</li>
                     ...
                     <div class="status-dropdown-menu">
                        <ul>
                           <li class="status-option" data-status="active" onclick="setStatus('active', 'Active')">
                              Active</li>
                           <li class="status-option" data-status="closed" onclick="setStatus('closed', 'Resolved')">
                              Resolved</li>
                        </ul>
                     </div>
                  </div>
